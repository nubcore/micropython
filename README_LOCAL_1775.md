...
[![Coverage 
Status](https://coveralls.io/repos/micropython/micropython/badge.png?branch=master)](https://coveralls.io/r/micropython/micropython?branch=master)

The MicroPython project
=======================
<p align="center">
  <img 
src="https://raw.githubusercontent.com/micropython/micropython/master/logo/upython-with-micro.jpg" 
alt="MicroPython Logo"/>
</p>
...
See the repository http://github.com/micropython/pyboard for the 
MicroPython
...
- ports/pic16bit/ -- a version of MicroPython for 16-bit PIC 
microcontrollers.
- ports/cc3200/ -- a version of MicroPython that runs on the CC3200 from 
TI.
...
writing some assembly code for the exception handling and garbage 
collection.
...
3V3 pin to the P1/DFU pin with a wire (on PYBv1.0 they are next to each 
other
...
This will use the included `tools/pydfu.py` script.  If flashing the 
firmware
...
and the [Code 
Conventions](https://github.com/micropython/micropython/blob/master/CODECONVENTIONS.md).
Note that MicroPython is licenced under the MIT license, and all 
contributions
